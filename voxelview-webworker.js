  ...
  try {
    ...
    while (true) {
      ...
      if (i === layersLength - 1) {
        ...
        if (numSegClasses !== expected_Num_labels) {
          // errTxt = "expected " + expected_Num_labels + " labels, but the predicted are " + numSegClasses + ". For possible solutions please refer to <a href='https#Q3' target='_blank'><b> FAQ </b></a>.", "alert-error"
